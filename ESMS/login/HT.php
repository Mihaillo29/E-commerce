...
@media screen and (min-width: 1336px){
    ...
    <body>
      <?php   //print_r($_SESSION['cart']); ?>  <!-- error   --> 
        <div class = "container" class="products"> 
            <div class = "row" class="container"> 
			
<?php 
$query = "SELECT * FROM home_th";
	...
	while($product= mysqli_fetch_array($queryfire)){     // error line     
		...
		?> 
            ...
            <div class = "col-lg-3" class="product-item"> 
                    <!-- single product - action="index.php?action=add&id="-->
			  <form action="cart.php?id= <?= $product['id'];?>" method="post"  enctype="multipart/form-data" >
                <div class = "card" class="product">  
                            ...
                            <div class = "product-info">
                                <div class = "product-info-top"> 
                                 ...
                                 <p class = "product-name"  ><?php echo $product['id']; ?><br>
							...
							<div >
							<center>
                                  <button type = "submit" name="add_to_cart" class="btn btn-info" value="add to cart"> add to cart
