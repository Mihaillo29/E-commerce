<?php  
// INSERT INTO `mobile` (`id`, `image`, `description`, `price`,`tstamp`) VALUES (NULL, 'But Books', 'Please buy books from Store', current_timestamp());
$insert = false;
$update = false;
$delete = false;
...
if (isset( $_POST['idEdit'])){
  ...
  $sql = "UPDATE `mobiles` SET `id` = '$id' , `image` = '$image'  , `description` = '$description'  , `price` = '$price' WHERE`id` = $id";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
    ...
    $price = $_POST["price"];
  // Sql query to be executed
  $sql = "INSERT INTO `mobiles` (`image`, `description` , `price`) VALUES ('$image', '$description' , '$price')";
  $result = mysqli_query($conn, $sql);
        ...
        <form action="mobile.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="title">Note image</label>
            ...
            <div class="form-group">
			  ...
			  <div class="form-group">
              <label for="desc">Note price</label>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <li class="nav-item">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="mobile.php" style="color:#81f0c9;">MOBILE<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="laptop_crud.php" style="color:white;">Laptop</a>
        </li>
		        <li class="nav-item">
          <a class="nav-link" href="TV_crud.php" style="color:white;">TV</a>
        </li>
		        <li class="nav-item">
          <a class="nav-link" href="HT_crud.php" style="color:white;">HOME_THEATER</a>
        </li>
      </ul>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `mobile.php?delete=${id}`;
