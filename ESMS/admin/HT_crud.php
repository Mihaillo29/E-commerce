...
if(isset($_GET['delete'])){
  $id = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `home_th` WHERE `id` = $id";
...
if (isset( $_POST['idEdit'])){
  ...
  $sql = "UPDATE `home_th` SET `id` = '$id' ,`name` = '$name' , `image` = '$image'  , `description` = '$description'  , `price` = '$price' WHERE`id` = $id";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
    ...
    $price = $_POST["price"];
  // Sql query to be executed
  $sql = "INSERT INTO `home_th` (`name`,`image`, `description` , `price`) VALUES ('$name','$image', '$description' , '$price')";
  $result = mysqli_query($conn, $sql);
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="HT_crud.php" method="POST">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <li class="nav-item">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="HT_crud.php" style="color:#81f0c9;">HOME THEATER<span class="sr-only">(current)</span></a>
        </li>
      </ul>
  ...
  <div class="container my-4">
    ...
    <table class="table" id="myTable">
      <thead>
        <tr>
          <th scope="col">Id</th>
          <th scope="col" type="hidden">name</th>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `HT_crud.php?delete=${id}`;
