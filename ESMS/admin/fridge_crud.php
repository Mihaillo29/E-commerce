...
if (isset( $_POST['idEdit'])){
  ...
  $sql = "UPDATE `fridge` SET `id` = '$id' , `image` = '$image'  , `description` = '$description'  , `price` = '$price' WHERE`id` = $id";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
    ...
    $price = $_POST["price"];
  // Sql query to be executed
  $sql = "INSERT INTO `fridge` (`image`, `description` , `price`) VALUES ('$image', '$description' , '$price')";
  $result = mysqli_query($conn, $sql);
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="fridge_crud.php" method="POST">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <li class="nav-item">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="fridge_crud.php" style="color:#81f0c9;">FRIDGE<span class="sr-only">(current)</span></a>
        </li>
      </ul>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `fridge_crud.php?delete=${id}`;
